...
<head>
  ...
  <link href="./assets/demo/styles.css" rel="stylesheet" />
</head>
...
<body class="index-page sidebar-collapse">
  ...
  <div class="wrapper">
    <div class="page-header clear-filter" filter-color="black"    >
      <div class="page-header-image  "  data-parallax="true" style="background-image:url('./assets/img/home.jpg');" >
      </div>
      <div class="container">
        <div class="content-center brand">
          <img class="n-logo" src="./assets/img/lg.png"  alt="">
          <h1 class="title"  font> PISCINAS " EL DORADO."</h1>
          <h3 class="title jean">  <strong> SIN AGUA NO HAY DIVERCION (:3). </strong></h3>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-10 ml-auto col-xl-6 mr-auto">
              ...
              <div class="card">
                <div class="card-header">
                  <ul class="nav nav-tabs nav-tabs-neutral justify-content-center" role="tablist" data-background-color="violet">
                    <li class="nav-item">
...
<div class="login-logo">
  ...
  <img src="views/img/plantilla/logo.png" class="img-responsive" style="padding:30px 100px 0px 100px">
...
<div class="login-box-body">
  ...
  <form  method="post" action="controlers/ControladorIdentificador.php">
    <div class="form-group has-feedback">

      <input type="text" class="form-control" placeholder="ingUsuario" name="ingUsuario" required >
